...
import InitialHtmlPlugin from './plugins/initial-html-plugin';
import InitialTextPlugin from './plugins/initial-text-plugin';
import UpdatePlugin from './plugins/update-plugin';
import TextAlignmentPlugin from './plugins/text-alignment-plugin';
import ElementFormatPlugin from './plugins/element-format-plugin';
