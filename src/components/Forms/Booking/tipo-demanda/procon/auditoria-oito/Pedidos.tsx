      ...
      <div className="space-y-4 bg-cyan-50 dark:bg-cyan-950/30 p-3 rounded-md">
            ...
            <Controller
              ...
              render={({ field }) => (
                <Select
                  ...
                  <SelectTrigger ref={field.ref} className={formBag.formState.errors.objeto ? "border-red-500" : ""}>
        ...
        <div>
          <Controller
            name="numero_reserva"
            control={formBag.control}
            render={({ field: fieldNumeroReserva }) => (
              <div>
                <Controller
                  ...
                  render={({ field: fieldAuditado }) => (
                    <div className="group flex gap-2 items-center">
                      ...
                      >
                        ...
                        <Input
                          ref={fieldNumeroReserva.ref}
                          type="text"
                          disabled
                          placeholder="Número da reserva"
                          className="w-full p-2 border rounded-md text-sm"
                          onChange={(e) => handleNumeroReservaChange(e, fieldNumeroReserva)}
                          value={fieldNumeroReserva.value}
                        />
                      </ValidadorCampoAuditoria>
                    </div>
                  )}
