      ...
      <div className="space-y-4 bg-blue-50 dark:bg-blue-950/50 p-3 rounded-md mb-4">
        ...
        <div className="space-y-2">
          ...
          <Controller
            name="data_defesa"
            control={control}
            render={({ field: fieldDataDefesa }) => (
              <Controller
                name="campos_auditados.data_defesa"
                control={control}
                render={({ field: fieldAuditado }) => (
                  <div className="group flex gap-2 items-center">
                    <ValidadorCampoAuditoria 
                    ...
                    >
                      <DateTimePicker
                        date={fieldDataDefesa.value ? new Date(fieldDataDefesa.value) : undefined}
                        onSelect={fieldDataDefesa.onChange}
                        disabled
                      />
                    </ValidadorCampoAuditoria>
                  </div>
