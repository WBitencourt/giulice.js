...
export function FormProconBookingAuditoriaOito({ params }: FormProconBookingAuditoriaOitoProps) {
  ...
  const validarCamposAuditados = () => {
    const camposAuditaveis = formBag.getValues()?.campos_auditados as CamposAuditadosProcon;
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                ...
                <div className="flex justify-center space-x-2">
                  <Button type="submit" className="bg-green-700" disabled={formBag.formState.isSubmitting}>
