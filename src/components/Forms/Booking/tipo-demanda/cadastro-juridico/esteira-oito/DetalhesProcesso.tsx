...
interface DetalhesProcessoProps {
  ...
  isSavingDesdobramento: boolean;
  onSalvarDesdobramento: () => void;
}
...
const DetalhesProcessoComponent = ({ 
  ...
  isSavingDesdobramento,
  onSalvarDesdobramento
          ...
          <div className="mt-3 pl-4 border-l-2 border-blue-300 space-y-4">
            ...
            <div className="flex justify-center space-x-2">
              <Button 
                type="button" 
                variant="outline" 
                disabled={isSavingDesdobramento} 
                onClick={handleClickSalvarDesdobramento}
              >
                {isSavingDesdobramento ? 'Salvando...' : 'Salvar desdobramento'}
              </Button>

              <Button 
                type="submit" 
                disabled={formState.isSubmitting || Object.keys(errors).length > 0}
              >
                {formState.isSubmitting ? 'Submetendo...' : 'Submeter desdobramento'}
              </Button>
            </div>
          </div>
        )}
