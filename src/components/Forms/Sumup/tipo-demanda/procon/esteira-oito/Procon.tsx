...
const ProconComponent = ({ formBag, validaDataAudiencia, validaDataReclamacao }: ProconProps) => {
  ...
  const handleDataAudienciaChange = (selectedDate: Date | null, field: ControllerRenderProps<DadosDemandaProcon, "data_audiencia">) => {
  ...
  const handleDataReclamacaoChange = (selectedDate: Date | null | undefined, field: ControllerRenderProps<DadosDemandaProcon, "data_reclamacao">) => {
            ...
            <Controller
                ...
                render={({ field }) => (
                  <div className="group flex gap-2 items-center">
                    ...
                    />
                    <X
                      onClick={() => handleDataReclamacaoChange(null, field)}
                      className="w-4 h-4 cursor-pointer text-gray-400 hover:text-red-500"
                    />
                  </div>
                )}
