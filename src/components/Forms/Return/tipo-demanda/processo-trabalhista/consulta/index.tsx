...
export function FormProcessoTrabalhistaReturnConsultaDemandas({ params }: FormProcessoTrabalhistaReturnConsultaDemandasProps) {
  ...
  const formatInitialFormValues = useCallback((values: Partial<DemandaProcessoTrabalhistaReturn>) => {
  ...
  const updateInitialFormValues = useCallback((newValues: Partial<DemandaProcessoTrabalhistaReturn>) => {
    try {
