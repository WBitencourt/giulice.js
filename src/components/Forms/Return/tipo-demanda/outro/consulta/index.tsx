...
export function FormDemandaOutroReturnConsultaDemanda({ params }: FormDemandaOutroReturnConsultaDemandaProps) {
  ...
  const formatInitialFormValues = useCallback((values: Partial<DemandaOutroReturn>) => {
  ...
  const updateInitialFormValues = useCallback((newValues: Partial<DemandaOutroReturn>) => {
    try {
