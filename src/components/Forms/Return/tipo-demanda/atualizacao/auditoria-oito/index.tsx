...
export function FormAtualizacaoReturnAuditoriaOito({ params }: FormAtualizacaoReturnAuditoriaOitoProps) {
  ...
  const formatInitialFormValues = useCallback((values: Partial<DemandaAtualizacaoReturn>) => {
  ...
  const updateInitialFormValues = useCallback((newValues: Partial<DemandaAtualizacaoReturn>) => {
    try {
      ...
      formBag.reset({ 
        ...oldValues, 
        ...formatInitialFormValues(newValues), 
      });
